                ...
                <div className="container">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="flex items-center lg:hidden">
                            ...
                            <div>
                                <ul className={isOpen ? 'absolute right-0 top-full w-full rounded-lg bg-white py-4 md:py-8 shadow-lg duration-500 ease-in-out space-y-2 md:space-y-4': 'fixed left-[-100%] duration-500 ease-in-out'}>
                                    ...
                                    <li className="text-center"><a href="" className="text-sm font-medium transition-all duration-300 text-secondary hover:text-primary">Artikel</a></li>
                                    <li className="text-center"><a href="" className="text-sm font-medium transition-all duration-300 text-secondary hover:text-primary">Campaign</a></li>
                                    <li className="text-center"><a href="" className="text-sm font-medium transition-all duration-300 text-secondary hover:text-primary">Edukasi</a></li>
                                    <li className="text-center"><a href="" className="text-sm font-medium transition-all duration-300 text-secondary hover:text-primary">Contact</a></li>
                                    <li className="text-center"><a href="" className="text-sm font-medium transition-all duration-300 text-secondary hover:text-primary">About Us</a></li>
                        ...
                        <ul className="hidden lg:flex gap-x-8">
                            ...
                            <li><a href="" className="font-medium transition-all duration-300 text-secondary hover:text-primary">Artikel</a></li>
                            <li><a href="" className="font-medium transition-all duration-300 text-secondary hover:text-primary">Campaign</a></li>
                            <li><a href="" className="font-medium transition-all duration-300 text-secondary hover:text-primary">Edukasi</a></li>
                            <li><a href="" className="font-medium transition-all duration-300 text-secondary hover:text-primary">Contact</a></li>
                            <li><a href="" className="font-medium transition-all duration-300 text-secondary hover:text-primary">About Us</a></li>
